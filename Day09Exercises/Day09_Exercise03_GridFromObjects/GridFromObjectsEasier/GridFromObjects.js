...
//iterate through each book OF books.
for(let book of books) {

    //Within each book, you want to iterate through each property IN that book
    //so you'll need a for in loop here.

        //For each property in book, you want to create a div

        //make its text content the value for that property

        //give it a class name of "item"

        //and then append that newly-created div into the grid
