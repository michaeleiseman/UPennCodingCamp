...
function pickBirthdays() {
    ...
    //set text to indicate no duplicate date was found
    let text = "None of the people have the same birthday.";
    //if a duplicate was found
    if(duplicateFound) {
        //set text to indicate that a duplicate was found
        text = "At least two people have the same birthday on " + dates[i - 1] + "."
    }
    //place the text in the page output element
